...
type testCase struct {
	...
	expectedP1    int // Expected answer for Part 1
	expectedP2    int // Expected answer for Part 2
}
...
// TestSolve runs all defined test cases
...
func TestSolvePartOne(t *testing.T) {
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			p1, err := day01.Solve(1, testLogger, tc.inputFilePath)
			if err != nil {
...
func TestSolvePartTwo(t *testing.T) {
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			p2, err := day01.Solve(2, testLogger, tc.inputFilePath)
			if err != nil {
